...
class LoginAndSignUp : public MThread {
	...
	Dispatcher* dispatcher; // once the user logged in he "moves on" to the dispatcher
	bool status;
...
#endif /* LOGINANDSIGNUP_H_ */     // !LOGINANDSIGNUP_H_
